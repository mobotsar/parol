...
impl UserActionsTrait<'_> for BooleanGrammar {
    ...
    fn call_semantic_action_for_production_number(
        ...
        match prod_num {
            ...
            3 => self.expressions_opt(&children[0], parse_tree),
            4 => self.expressions_list_0(&children[0], &children[1], &children[2], parse_tree),
            5 => self.expressions_list_1(parse_tree),
            6 => self.expression(&children[0], &children[1], parse_tree),
            7 => self.tail_expression(&children[0], parse_tree),
            8 => self.tail_expression_list_0(&children[0], &children[1], &children[2], parse_tree),
            9 => self.tail_expression_list_1(parse_tree),
            10 => self.term_0(&children[0], &children[1], parse_tree),
            11 => self.term_1(&children[0], parse_tree),
            12 => self.term_opt(&children[0], parse_tree),
            13 => self.boolean_0(&children[0], parse_tree),
            14 => self.boolean_1(&children[0], parse_tree),
            15 => self.unary_operator(&children[0], parse_tree),
            16 => self.binary_operator_0(&children[0], parse_tree),
            17 => self.binary_operator_1(&children[0], parse_tree),
            18 => self.binary_operator_2(&children[0], parse_tree),
            19 => self.binary_operator_3(&children[0], parse_tree),
            20 => self.binary_operator_4(&children[0], parse_tree),
            21 => self.binary_operator_5(&children[0], parse_tree),
            22 => self.and_op(&children[0], parse_tree),
            23 => self.or_op(&children[0], parse_tree),
            24 => self.xor_op(&children[0], parse_tree),
            25 => self.nor_op(&children[0], parse_tree),
            26 => self.nand_op(&children[0], parse_tree),
            27 => self.xnor_op(&children[0], parse_tree),
            28 => self.r#true(&children[0], parse_tree),
            29 => self.r#false(&children[0], parse_tree),
            30 => self.not(&children[0], parse_tree),
            31 => self.parenthesized(&children[0], &children[1], &children[2], parse_tree),
            32 => self.semicolon(&children[0], parse_tree),
            33 => self.left_parenthesis(&children[0], parse_tree),
            34 => self.right_parenthesis(&children[0], parse_tree),
            35 => self.factor_0(&children[0], parse_tree),
            36 => self.factor_1(&children[0], parse_tree),
